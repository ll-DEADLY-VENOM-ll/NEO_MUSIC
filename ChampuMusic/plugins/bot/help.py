...
async def about_callback(client: Client, callback_query: CallbackQuery):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="[ ɪɴsᴛᴀ ]", url=f"https://www.instagram.com/hyper_trading_official?igsh=NW84Y290ZWkwa21u"),
            InlineKeyboardButton(text="[ ʏᴏᴜᴛᴜʙᴇ ]", url=f"https://youtube.com/@hyper_trading_official"),
        ],
        [
...
async def music_callback(client: Client, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit(
        f"``**Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ.](https://t.me/Science_Sangrah_Official01)**\n\n**Aʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ: /**``",
        reply_markup=keyboard,
    )
...
async def back_button_callback(client: Client, callback_query: CallbackQuery):
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                text="ɢɪᴛʜᴜʙ",
                url="https://github.com/Tanya_Singh_Vns_Up",
            ),
        ],
        [
...
async def settings_back_callback(client: Client, callback_query: CallbackQuery):
    ...
    await callback_query.message.reply_photo(
        photo="https://files.catbox.moe/mz6ps1.jpg",
